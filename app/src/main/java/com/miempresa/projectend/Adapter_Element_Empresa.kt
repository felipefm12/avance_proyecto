...
class Adapter_Element_Empresa(var context : Context , items:ArrayList<Elements_Empresa>): BaseAdapter() {

    var items:ArrayList<Elements_Empresa>? = null
    var itemsCopia:ArrayList<Elements_Empresa>? = null
    ...
    override fun getView(position : Int , converView : View? , parent : ViewGroup?) : View {
        ...
        if (view == null){
            view = LayoutInflater.from(context).inflate(R.layout.elements_empresa, null)
        ...
        val item = items?.get(position) as Elements_Empresa
    ...
    private class ViewHolder(view : View){
        ...
        init {
            ...
            imagen = view.findViewById(R.id.imagenElement)
